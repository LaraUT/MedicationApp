   ...
   <div>
    ...
    <div className='bg-white rounded-sm  w-[60%] mx-auto h-[90%] border-x-2 border-b-4 border-t flex items-center  justify-center flex-wrap py-20'>
      ...
      <table className='my-0.5 font-semibold'>
         ...
         <th className=' w-40 h-2 font-semibold '>Comentarios</th>
         </tr>
         </thead> 
         </table>
      ...
      <table className='my-0.5'>
         ...
         <thead>
         <tr className='items-center justify-center '>
         <th className='bg-[#7BDD74] w-40 h-28 border-r-2n font-semibold'>Solo cuando sea necesario</th> 
         ...
         <th className='bg-[#B9FFB3] w-40 h-28 border-r-2n font-semibold'>Quinta columna</th>
         </tr>
         </thead> 
         </table>
