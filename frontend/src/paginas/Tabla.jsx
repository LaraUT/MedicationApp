    ...
    <>
      ...
      <div>
        ...
        <div>
          ...
          <h2 className="w-full flex-col text-center text-3xl p-5">MEDICAMENTOS</h2>
        </div>
        ...
        <button className="text-black border-red-600 border-2 transition-all duration-300 ease-in-out hover:bg-red-700 focus:ring focus:outline-none focus:ring-red-300 m-3 px-2 border border-red-600 rounded-sm w-32"
