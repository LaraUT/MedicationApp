...
function Tabla() {
  ...
  const [ayuda3, setAyuda3] = useState(false)
    ...
    <>
      ...
      <div>
        ...
        <div className='flex items-center justify-between w-full'> 
          ...
          <button  className="font-normal w-56 border-2 rounded-md px-5 border-[#0066b2] text-[#0066b2] hover:text-[#007FFF] hover:border-[#007FFF] hover:bg-[#007FFF] hover:bg-opacity-20 transition-all ease-in-out focus:ring focus:ring-[#00bfff] focus:[#0066b2]" onClick={()=> {abrir()}} >
  ...
  <div className="fixed inset-0 bg-black bg-opacity-20 backdrop-blur-sm flex justify-center items-center">
    <div className="bg-white p-5 rounded flex flex-col justify-center items-center gap-5 h-2/4 w-2/5 relative">
      ...
      <h6 className="text-sm text-justify">¡Estamos Aquí para Ayudarte! En MedicTabs, nuestra misión facilitarte el seguimiento de tu plan de medicamentos.</h6>
      ...
      <div className="w-3/4 flex justify-center">
        <button className="px-2 border-2 border-sky-500 text-sky-500 rounded-md mb-1.5 transition-all duration-300 ease-in-out hover:bg-sky-500 hover:text-white focus:bg-sky-700 focus:text-white" onClick={() => { ayuda2Change() }}>
          Entendido!
        </button>
      </div>
    </div>
...

      {
        ayuda3 &&(
          ...
          <div className="bg-white py-2 px-5 border-slate-300 border   rounded flex flex-col justify-center items-center ">
              ...
              <button className='px-2 border-2 border-sky-500 text-sky-500 rounded-md mb-1.5 transition-all duration-300 ease-in-out hover:bg-sky-500 hover:text-white focus:bg-sky-700 focus:text-white ' onClick={() => {setAyuda3(false)}}>Entendido!
              </button>
